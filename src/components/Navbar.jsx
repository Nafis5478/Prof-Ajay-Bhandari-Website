  ...
  return (
    <div className='bg-gray-300 text-black flex justify-between items-center h-20 w-full pl-8 pr-4 fixed'>
        ...
        <ul className="hidden lg:flex gap-2 items-center">
            <Link to='/'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/'?'bg-slate-100 rounded-xl':''}`}>Home</li>
            </Link>
            <Link to='/about'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/about'?'bg-slate-100 rounded-xl':''}`}>About me</li>
            </Link>
            <Link to='/research'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/research'?'bg-slate-100 rounded-xl':''}`}>Research</li>
            </Link>
            <Link to='/publication'>
            ...
            <Link to='/people'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/people'?'bg-slate-100 rounded-xl':''}`}>People</li>
            </Link>
            <Link to='/lab'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/lab'?'bg-slate-100 rounded-xl':''}`}>Lab</li>
            </Link>
            <Link to='/project'>
                <li className={`cursor-pointer font-medium text-black px-4 hover:scale-105 hover:bg-slate-100 rounded-xl ${location.pathname==='/project'?'bg-slate-100 rounded-xl':''}`}>Project</li>
            </Link>
            <Link to='/contact'>
