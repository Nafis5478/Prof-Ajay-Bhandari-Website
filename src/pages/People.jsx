              ...
              <div className="shadow-gray-500 shadow-lg flex flex-col md:flex-row p-4 gap-2 bg-gray-50 ">
                ...
                <div className="p-2 md:w-3/5">
                  ...
                  <p>
                    ...
                    Biofluid research lab under the supervision of{" "}
                    <span className="font-semibold">Prof. Ajay Bhandari</span>.
                    My research interests are Biofluid mechanics and heat
                    transfer, CFD investigation of upper respiratory system,
                    Hemodynamics, Fluid-structure interactions, and Virtual
                    surgery. The title of my thesis is "
              ...
              <div className="shadow-gray-500 shadow-lg flex flex-col md:flex-row-reverse p-4 gap-2 bg-gray-50 ">
                ...
                <div className="p-2 md:w-3/5">
                  ...
                  <p>
                    ...
                    Dhanbad, for my Ph.D. I am pursuing my Ph.D. research in the
                    Biofluid research lab under the supervision of{" "}
                    <span className="font-semibold">Prof. Ajay Bhandari</span>{" "}
              ...
              <div className="shadow-gray-500 shadow-lg flex flex-col md:flex-row-reverse p-4 gap-2 bg-gray-50">
                ...
                <div className="p-2 md:w-3/5">
                  ...
                  <p>
                    ...
                    Steel, Jamshedpur, where I worked on a project titled
                    "Graphene from waste oil" during my MTech course.
                    Previously, I served as a Junior Research Fellow at
                    CSIR-CMERI, Durgapur, from August 2019 to January 2021,
                    contributing to the project "Design and Development of Small
                    Utility Compact Tractor." Before that, I gained experience
                    as a Graduate Apprenticeship Trainee at DTPS, DVC Durgapur,
                    from October 2018 to August 2019. I graduated with a
                    Bachelor's degree in Mechanical Engineering from Aryabhatta
                    Institute of Engineering and Management, Durgapur, in 2018.
                  </p>
                </div>
              </div>
            </li>
              ...
              <div className="shadow-gray-500 shadow-lg flex flex-col md:flex-row p-4 gap-2 bg-gray-50">
                ...
                <div className="p-2 md:w-3/5">
                  ...
                  <p>
                    ...
                    B.I.T SINDRI, Dhanbad, Jharkhand in the year 2021. My B.Tech
                    project was "LPG Based Refrigeration System".
                  </p>
                </div>
              </div>
            </li>
